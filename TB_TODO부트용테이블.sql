...
SELECT TODO_NO, TODO_TITLE, TODO_CONTENT, COMPLETE, TO_CHAR(REG_DATE, 'YYYY-MM-DD HH24:MI:SS') REG_DATE FROM TB_TODO
WHERE TODO_NO = 1;

UPDATE TB_TODO
SET TODO_CONTENT = '수정된 테스트1 입니다.' , TODO_TITLE = '수정된 테스트1'
WHERE TODO_NO = 1;
