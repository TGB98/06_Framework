...
public class EmailConfig {
	...
	// @Value : properties 에 작성된 내용 중 key가 일치하는 value 값을 얻어와 필드에 대입 해줌.
	...
	public JavaMailSender javaMailSender() {
		 ...
		 * 
		 * SMTP 서버를 사용해 이메일을 보내기 위한 구성을 제공.
		 * 
		 * */
		...
		mailSender.setJavaMailProperties(prop); // JavaMail의 속성을 설정(앞서 정의해둔 prop 설정들을 추가)
		
		
		return mailSender;
		// 위의 각종 설정이 적용된 JavaMailSender를 Bean으로 등록해 
